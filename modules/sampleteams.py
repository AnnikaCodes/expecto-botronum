...
htmlboxes: Dict[str, List[Dict[str, Union[str, List[str]]]]] = {
    ...
    "gen8sspts": [
        {
            "tier": "[Gen 8] SSPTS",
            "name": "Hazards Offensive",
            "pokemon": ["skarmory", "vibrava", "snorlax", "rotom-fan", "astrolotl", "lopunny-mega"],
            "pokepasteURL": "https://pokepast.es/5c9ddc5327ef4d6f",
            "username": "Capinhao General",
        },
        {
            "tier": "[Gen 8] SSPTS",
            "name": "Hyper Offensive",
            "pokemon": ["gliscor", "oranguru", "lopunny-mega", "zapdos", "porygon2", "vibrava"],
            "pokepasteURL": "https://pokepast.es/15b219187ffc8f3b",
            "username": "ReturnToMonkey",
        },
        {
            "tier": "[Gen 8] SSPTS",
            "name": "Rain Balanced",
            "pokemon": ["wooper", "gyarados", "tornadus-therian", "pyukumuku", "sceptile", "skarmory"],
            "pokepasteURL": "https://pokepast.es/334a19873b84cf2d",
            "username": "Woopersons42",
        },
        {
            "tier": "[Gen 8] SSPTS",
            "name": "Monkey Room",
            "pokemon": ["porygon2", "lopunny-mega", "oranguru", "skarmory", "indeedee-f", "wooper"],
            "pokepasteURL": "https://pokepast.es/b92667d8bd15d0f6",
            "username": "spx1",
        },
        {
            "tier": "[Gen 8] SSPTS",
            "name": "Trick Room Balanced",
            "pokemon": ["pyukumuku", "oshawott", "indeedee-f", "porygon2", "tapu-fini", "drampa"],
            "pokepasteURL": "https://pokepast.es/633edab5fcb635e9",
            "username": "Capinhao General",
        },
    ],
    "gen8nfe": [
