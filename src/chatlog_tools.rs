...
pub fn search(
    ...
    while let Some(row) = rows.next()? {
        ...
        let date = NaiveDateTime::from_timestamp(
            // TODO: properly account for timezones
...
pub mod tests {
    ...
    fn search_test() -> Result<(), rusqlite::Error> {
        ...
        assert_eq!(
            results,
            r#"<details><summary>Messages in test sent by annika</summary><details style="margin-left: 5px;"><summary><b>Oct  8, 2020</b></summary><div style="margin-left: 10px;"><small>[<a href="http://logs.psim.us:8080/test/2020-10/2020-10-08.html#00:25">00:25:40</a>] </small><small>@</small><b>Annika</b>: Test Message One<br></div></details></details>"#
        );
